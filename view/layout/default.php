...
<header>
    <nav class="navbar navbar-expand-lg justify-content-between">
        <a class="navbar-brand link" href="<?= BASE_URL; ?>">
            <img id="logo" width="125px" height="50px" src="<?= BASE_SITE . DS . "img/logo_site2.png" ?>" alt="Logo de l'UFOLEP">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav" style="padding-right:50px;">
                ...
                <li class="nav-item">
                    <a class="nav-link link" href="<?= BASE_URL . DS . "championnat/ancienneListe"; ?>">Anciens Championnats</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link link" href="<?= BASE_URL . DS . "joueur/liste"; ?>">Classement individuel</a>
                </li>
                <li class="nav-item">
                    <a href="<?= BASE_URL . DS . "info/contact" ?>" class="nav-link link">Contact</a>
                </li >
