...
require_once ROOT . DS . "view" . DS . "layout" . DS . "guest" . DS . "_guest_top.php"; ?>
    ...
    <div>
        ...
        <table class="data-table">
            ...
            <?php foreach ($equipes as $e) : ?>
                <tr>
                    ...
                    <td> <?= $e->idDivision ?></td>
                    <td>
                       <a href="<?= BASE_URL . DS . "view" . DS . "equipes" . DS . "joueursEquipe.php?idEquipe=" . $e->idEquipe ?>">
        ...
        if (isset($_GET['nomEquipe'])) {
            ...
            // Utilisez la valeur de $nomEquipe selon vos besoins
            echo "L'équipe sélectionnée est : " . $nomEquipe;
        }
    ?>
    </div>
